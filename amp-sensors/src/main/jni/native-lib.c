...
Java_com_kynetics_ampsensors_ModuleFragment_arrayModuleFromJNI(JNIEnv *env, jobject instance) {
...
JNIEXPORT jfloatArray JNICALL
Java_com_kynetics_ampsensors_RawFragment_arrayRawFromJNI(JNIEnv *env, jobject instance) {
...
Java_com_kynetics_ampsensors_MainActivity_createDevice(JNIEnv *env, jobject instance) {
...
JNIEXPORT jstring JNICALL
Java_com_kynetics_ampsensors_MainActivity_destroyDevice(JNIEnv *env, jobject instance) {
...
JNIEXPORT jstring JNICALL
Java_com_kynetics_ampsensors_ModuleFragment_destroyDevice(JNIEnv *env, jobject instance) {
